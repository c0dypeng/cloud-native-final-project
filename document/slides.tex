...
\begin{column}{0.48\textwidth}
  ...
  \end{block}
  \vspace{0.3cm}
  \begin{alertblock}{SLO 目標}
    \begin{itemize}\small
      \item p95 回應時間 \textbf{\textless{} 500 ms}
      \item 錯誤率 \textbf{\textless{} 0.5\%}
      \item 持續 30 秒高峰不降級
    \end{itemize}
  \end{alertblock}
\end{column}
...
\begin{exampleblock}{測試小結}
  ...
  負載測試 k6 1k VU × 30s，目標 p95 \textless{} 500ms、錯誤率 \textless{} 0.5\%。
\end{exampleblock}
\end{frame}
...
\begin{column}{0.24\textwidth}
  \begin{block}{\centering 系統測試}
    \centering\small 整合 + k6 負載\\1k VU / p95 \textless{} 500ms
  \end{block}
\end{column}
\begin{column}{0.24\textwidth}
